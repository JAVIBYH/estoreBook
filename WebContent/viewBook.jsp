            ...
            <div class="cn5_top_y center01">
            	<div class="cn5topy_1">
                	<div class="cn5topy_imgview">
                    	<img src="${bookInfoById.img.split('[#]')[0] }"/>
                ...
                <div class="cn5topy_2">
                	<h1 class="pro_title font15">${bookInfoById.name }</h1>
                    <div class="pro_price">
                            <div class="pro_price_x">
                                <p> briup价：<b>￥${bookInfoById.price }</b> <a href="#">(降价通知)</a></p>
                            </div>
                    ...
                    <div class="pro_selects">
                        ...
                        <div class="pro_select">
                            ...
                            <ul class="pro_select_vals">
                            	<li>描述：${bookInfoById.description }</li>
                                <li> 出版时间：${bookInfoById.pubDate }</li>
                                <li>包装：平装</li>
                                <li>正文语种：中文</li>
				...
				<form action="" id="addCar">
                    <div class="pro_buy">
                       ...
                       <!--  <div class="pro_addshop" onclick="submitForm()">加入购物车</div> -->
                         <div class="pro_addshop"><a href="addShopCarServlet?bookId=${bookInfoById.id }">加入购物车</a></div>
                    </div>
				</form>
                    <div class="pro_ship">
                        <div>
                ...
                <!--内容-->
              	<div class="c5_b2_right_1 box">
                        <div class="introduce_item">
                          <ul>
                        	<li>商品名称：${bookInfoById.name }</li>
                            <li>商品编号：${bookInfoById.id }</li>
                            <li class="fr"><a class="color_link1" href="#">更多参数>></a></li>
                          </ul>
                        </div>
               		</div>
                    <div class="intro_pics">
                    	<img class="intro_pic" src="${bookInfoById.img.split('[#]')[0] }">
                    </div>
                </div>
