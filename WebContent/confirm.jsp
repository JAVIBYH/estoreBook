...
<body>
    ...
    <div class="content">
		...
		<form action="orderList.jsp" name="orderForm">
    		...
    		<div class="bigDiv">
    			<div class="twoDiv">
    				...
    				<c:forEach items="${car.lines }" var="line">
						<ul class="oneUL">
	    					<li>
	    						<img src="${line.value.book.img.split('[#]')[0] }" class="pic">
	    						<p>计算机&nbsp;&nbsp;JAVA&nbsp;&nbsp;${line.value.book.name }&nbsp;&nbsp;</p>
	    						<p><font>¥${line.value.book.price }</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;×${line.value.num }&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;有货</p>
    		...
    		<div class="money">
    			<span><font>${car.num }</font>件商品，总商品金额：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¥${car.cost }</span>
