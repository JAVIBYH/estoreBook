...
<div class="empty">
	...
	<div class="mainCenter">
		...
		<div class="mainPro">
			...
			<c:forEach items="${car.lines }" var="line">
	            <form>
	                <table>
	                    <tbody>
	                        <tr>
	                            <td class="index">${line.key }</td>
	                            <td>
	                                <img src="${line.value.book.img.split('[#]')[0] }" width="70px" height="70px">
	                                 <span>
	                                    ${line.value.book.name }
	                                    <br>
	                                </span>
	                             </td>
	                            <td>
	                                <span>¥${line.value.book.price }</span>
	                            </td>
	                            <td class="index2">
	                                <input type="text" name="num" value="${line.value.num }"><br>
	                                <span>有货</span>
	                            </td>
	                            <td>
	                                <span>¥${line.value.num*line.value.book.price }</span>
	                            </td>
	                            <td>
	                                <button>保存</button>
	                                <button>取消</button>
 ...
 -->
             <!-- <div class="bb">
                ...
                <div class="allButtom">
                    ...
                    <span>已选择<font>${car.num }</font>件商品&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;总价(不含运费)：<font>¥${car.cost }元</font></span>
                </div>
